  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar" >
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-link" ><a class="link"href="#" style="text-decoration:none; color:black"><span class="material-icons"  style="font-size:1.5rem; margin-right:5px; margin-left:10px">shopping_cart</span>Carrito</a></li>
      </ul>
    </div>  
</nav>